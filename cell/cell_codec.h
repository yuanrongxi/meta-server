#ifndef __CELL_CODEC_H_
#define __CELL_CODEC_H_
...
#define READ_DATA_ERROR		0xffffffff
...
void		bin_stream_set_used_size(bin_stream_t* strm, uint32_t used);
...
uint32_t	mach_data_read(bin_stream_t* strm, uint8_t* str, size_t size);
